...
// WebUrl is the golang structure for table web_url.
type WebUrl struct {
	Id         int64       `json:"id"         ` //
	Name       string      `json:"name"       ` // 历史ID（即变更前ID）
	SourceKey  string      `json:"sourceKey"  ` // 基本户户名
	Sort       string      `json:"sort"       ` // 供应商ID
	Link       string      `json:"link"       ` // 银行信息ID
	Icon       string      `json:"icon"       ` // 基本户户名
